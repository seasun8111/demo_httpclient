...
public abstract class RSACoderUtil extends CoderUtil {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * RSA对AES密钥加密
         */
        byte[] result = encryptByPrivateKey(aesKey,prv_key);
        System.out.println(Base64.encodeBase64String(result));



        System.out.println(decryptByPubKey(result,pub_key));
     ...
     * @throws Exception
     */
    public static String getSign(String[] stringArray, String privateKey) throws Exception {

        Assert.notEmpty(stringArray, "空值加签异常");
